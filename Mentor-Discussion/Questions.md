...
### 박연희
모던 자바스크립트는 배우는 중인데 정말 함수의 형태가 다양하더라요. 특히 기명 함수 표현식이나 즉시 실행 함수, 고차 함수, 객체의 메소드로 함수를 사용하는 등등...을 어떻게 해야 잘 이용할 수 있을까 라는 의문이 들었습니다. 현업에서도 잘 이용하는 것들일까요? 기명 함수 표현식은 뭔가 자주 쓸 거 같은 형태인데 다른 것들은 어떨 때 쓰는지 알고 싶습니다.